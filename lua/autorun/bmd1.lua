...
local V = {
	...
	Members = {
		...
		CustomWheelPosFL = Vector(105,40,35),
		CustomWheelPosFR = Vector(105,-40,35),
		CustomWheelPosML = Vector(-10,40,35),
		CustomWheelPosMR = Vector(-10,-40,35),
		CustomWheelPosRL = Vector(-100,40,35),
		CustomWheelPosRR = Vector(-100,-40,35),
...
list.Set( "simfphys_vehicles", "bm1", V )
...
list.Set( "simfphys_lights", "bm1", light_table)
