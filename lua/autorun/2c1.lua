...
list.Set( "simfphys_lights", "c21", light_table)

local V = {
	Name = "2C1 Gvozdika",
	Model = "models/2c1.mdl",
	...
	Members = {
		...
		CustomWheelPosML = Vector(-65,0,25),
		CustomWheelPosMR = Vector(65,0,25),
...
list.Set( "simfphys_vehicles", "c21", V )
