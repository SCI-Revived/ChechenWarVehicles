...
util.AddNetworkString( "gaz66_register_tank" )
util.AddNetworkString( "gaz66_tank_do_effect" )
util.AddNetworkString( "gaz66_update_tracks" )

sound.Add( {
	name = "churchill_mk_vii_fire",
	channel = CHAN_STATIC,
	volume = 1.0,
	level = 140,
	pitch = { 90, 110 },
	sound = "simulated_vehicles/weapons/churchill_fire.wav"
} )
sound.Add( {
	name = "",
	channel = CHAN_STATIC,
...
sound.Add( {
	name = "churchill_mk_vii_fire2",
	channel = CHAN_STATIC,
	volume = 0.50,
	level = 140,
	pitch = { 90, 110 },
	sound = "^simulated_vehicles/weapons/t34_rocket.wav"
} )
