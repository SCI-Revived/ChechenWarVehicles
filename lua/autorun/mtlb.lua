...
local V = {
	...
	Members = {
		...
		CustomWheelPosRL = Vector(-110,40,35),
		CustomWheelPosRR = Vector(-110,-40,35),
...
list.Set( "simfphys_vehicles", "mt2", V )
...
list.Set( "simfphys_lights", "mt2", light_table)
