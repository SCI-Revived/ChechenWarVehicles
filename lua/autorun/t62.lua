...
local light_table = {
	...
	R_HeadLampPos = Vector(10,95,54),Vector(58,140,53.5),
...
list.Set( "simfphys_lights", "t62", light_table)

local V = {
	Name = "T-62",
	Model = "models/t_62.mdl",
...
list.Set( "simfphys_vehicles", "t62", V )
