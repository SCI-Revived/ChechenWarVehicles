...
local light_table = {
	L_HeadLampPos = Vector(-54,140,53.5),Vector(-58,140,53.5),
	L_HeadLampAng = Angle(15,90,0),
	R_HeadLampPos = Vector(54,140,53.5),Vector(58,140,53.5),
...
list.Set( "simfphys_lights", "t72b", light_table)

local V = {
	Name = "T-72B",
	Model = "models/t7_2b.mdl",
	...
	Members = {
		...
		CustomWheelPosFL = Vector(-35,112,35),
		CustomWheelPosFR = Vector(35,112,35),
		...
		ExhaustPositions = {
			{
				pos = Vector(-80,-100,50),
				ang = Angle(-30,0,0)
			},
			{
				pos = Vector(-75,-100,50),
				ang = Angle(-30,0,0)
			},
			{
				pos = Vector(-80,-100,50),
...
list.Set( "simfphys_vehicles", "t72b", V )
