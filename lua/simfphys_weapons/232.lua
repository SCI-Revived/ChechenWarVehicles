...
function simfphys.weapon:Initialize( vehicle )
    ...
    simfphys.RegisterCrosshair( vehicle:GetDriverSeat(),{ Attachment = "muzzle_left", Type = 3 } )
	simfphys.RegisterCamera( vehicle:GetDriverSeat(), Vector(-95,-22,-15), Vector(0,0,55), true, "muzzle_left" )
	...
	vehicle.pSeat[1]:SetParent(vehicle,vehicle:LookupAttachment("turret_yaw"))
